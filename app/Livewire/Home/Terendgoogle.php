...
{
    public string $title = 'ترند گوگل|trends google';
    public string $description="ترندهای سرچ گوگل که برای ساخت هشتگ و کلمات کلیدی موضوعات چالش قابل استفاده است|Google search trends that can be used to create hashtags and keywords for challenge topics";
    public $trends = [];
