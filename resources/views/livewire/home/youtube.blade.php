...
<div class="dark:bg-gray-800 h-auto justify-center
    ...
    <div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8"x-data>
        <h1 class="text-2xl mb-4"> <strong>دانلود ویدیو از اینستاگرام|downloader</strong></h1>
        <p>
...
<div id="pos-article-text-card-106821"></div>
        ...
        <div class="flex flex-wrap justify-center gap-4 px-4 py-2">
            <a target="_blank" href="https://yt6d.com/en/">
                <button class="bg-red-400 whitespace-nowrap px-6 py-2 m-1 rounded-md transition-all duration-300 hover:bg-red-600 hover:text-white">
                    لینک اول دانلود از یوتوب
                </button>
            </a>
            <a target="_blank" href="https://en.greenconvert.net/">
                <button class="bg-red-400 whitespace-nowrap px-6 py-2 m-1 rounded-md transition-all duration-300 hover:bg-red-600 hover:text-white">
                    لینک دوم دانلود از یوتوب
                </button>
            </a>
            <a target="_blank" href="https://y2mate.nu/en-szSi/">
                <button class="bg-red-400 whitespace-nowrap px-6 py-2 m-1 rounded-md transition-all duration-300 hover:bg-red-600 hover:text-white">
                    لینک سوم دانلود از یوتوب
                </button>
            </a>
        </div>

        <div class="flex flex-wrap justify-center gap-4 px-4 py-2">
            <a target="_blank" href="https://snapins.ai/">
                <button class="bg-pink-400 whitespace-nowrap px-6 py-2 m-1 rounded-md transition-all duration-300 hover:bg-pink-600 hover:text-white">
                    لینک اول دانلود از اینستاگرام
                </button>
            </a>
            <a target="_blank" href="https://igram.world/">
                <button class="bg-pink-400 whitespace-nowrap px-6 py-2 m-1 rounded-md transition-all duration-300 hover:bg-pink-600 hover:text-white">
                    لینک دوم دانلود از اینستاگرام
                </button>
            </a>
            <a target="_blank" href="https://fastdl.app/en">
                <button class="bg-pink-400 whitespace-nowrap px-6 py-2 m-1 rounded-md transition-all duration-300 hover:bg-pink-600 hover:text-white">
                    لینک سوم دانلود از اینستاگرام
                </button>
            </a>
        </div>
